...
static SettingsConfigEntry defaultEntries[] = {
    ...
    {ACONFIG_PARAM_DRIVES_RTC_NTP_HOST, SETTINGS_TYPE_STRING, "pool.ntp.org"},
    ...
    // GEMDRIVE configuration
    {ACONFIG_PARAM_DRIVES_GEMDRIVE_ENABLED, SETTINGS_TYPE_BOOL, "true"},
    {ACONFIG_PARAM_DRIVES_GEMDRIVE_FOLDER, SETTINGS_TYPE_STRING, "/hd"},
    {ACONFIG_PARAM_DRIVES_GEMDRIVE_DRIVE, SETTINGS_TYPE_STRING, "C"},
    {ACONFIG_PARAM_DRIVES_GEMDRIVE_READONLY, SETTINGS_TYPE_BOOL, "false"},

    // ACSI configuration
    {ACONFIG_PARAM_DRIVES_ACSI_ENABLED, SETTINGS_TYPE_BOOL, "false"},
    {ACONFIG_PARAM_DRIVES_ACSI_FIRST_UNIT, SETTINGS_TYPE_INT, "0"},
    {ACONFIG_PARAM_DRIVES_ACSI_IMAGE, SETTINGS_TYPE_STRING, ""},

    // FLOPPY configuration
    {ACONFIG_PARAM_DRIVES_FLOPPY_ENABLED, SETTINGS_TYPE_BOOL, "true"},
    {ACONFIG_PARAM_DRIVES_FLOPPY_FOLDER, SETTINGS_TYPE_STRING, "/floppies"},
    {ACONFIG_PARAM_DRIVES_FLOPPY_DRIVE_A, SETTINGS_TYPE_STRING, ""},
    {ACONFIG_PARAM_DRIVES_FLOPPY_DRIVE_B, SETTINGS_TYPE_STRING, ""},
    {ACONFIG_PARAM_DRIVES_FLOPPY_BOOT_ENABLED, SETTINGS_TYPE_BOOL, "true"},
    {ACONFIG_PARAM_DRIVES_FLOPPY_XBIOS_ENABLED, SETTINGS_TYPE_BOOL, "true"},
    {ACONFIG_PARAM_DRIVES_FLOPPY_DRIVE_A_2, SETTINGS_TYPE_STRING, ""},
    {ACONFIG_PARAM_DRIVES_FLOPPY_DRIVE_A_3, SETTINGS_TYPE_STRING, ""},
    {ACONFIG_PARAM_DRIVES_FLOPPY_DRIVE_A_4, SETTINGS_TYPE_STRING, ""},
    {ACONFIG_PARAM_DRIVES_FLOPPY_DRIVE_A_5, SETTINGS_TYPE_STRING, ""},
    {ACONFIG_PARAM_DRIVES_FLOPPY_DRIVE_A_6, SETTINGS_TYPE_STRING, ""},
    {ACONFIG_PARAM_DRIVES_FLOPPY_DRIVE_A_7, SETTINGS_TYPE_STRING, ""},
