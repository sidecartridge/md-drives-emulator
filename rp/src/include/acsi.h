...
// pun_info as AHDI 3.0 lays it out for the 68000, whose longs need only be
// even: puns, pun[16], then partition_start at $12, P_cookie $52, P_cookptr
// $56, P_version $5A, P_max_sector $5C, reserved $5E. The offsets used to be
// C's 4-byte alignment of a long (partition_start at +20 and everything after
// two bytes late), which only this firmware read correctly.
...
#define ACSIEMUL_PUN_INFO_PRT_START_OFFSET (ACSIEMUL_PUN_INFO_OFFSET + 0x12u)
#define ACSIEMUL_PUN_INFO_P_COOKIE_OFFSET (ACSIEMUL_PUN_INFO_OFFSET + 0x52u)
#define ACSIEMUL_PUN_INFO_P_COOKPTR_OFFSET (ACSIEMUL_PUN_INFO_OFFSET + 0x56u)
#define ACSIEMUL_PUN_INFO_P_VERSION_OFFSET (ACSIEMUL_PUN_INFO_OFFSET + 0x5Au)
#define ACSIEMUL_PUN_INFO_P_MAX_SECTOR_OFFSET (ACSIEMUL_PUN_INFO_OFFSET + 0x5Cu)
#define ACSIEMUL_PUN_INFO_RESERVED_OFFSET (ACSIEMUL_PUN_INFO_OFFSET + 0x5Eu)
...
#define ACSIEMUL_ST_PUN_INFO_COOKIE_PTR \
  (ACSIEMUL_ST_PUN_INFO_PTR + 0x52u)
...
#define ACSI_ASSERT_ALIGNED_2(offset) \
...
// Words and longs in the window are written a byte at a time, each 16-bit
// word byte-swapped for the 68000 (WRITE_WORD, WRITE_AND_SWAP_LONGWORD), so an
// even offset is all a long needs - as on the 68000.
ACSI_ASSERT_ALIGNED_2(ACSIEMUL_PUN_INFO_PRT_START_OFFSET);
ACSI_ASSERT_ALIGNED_2(ACSIEMUL_PUN_INFO_P_COOKIE_OFFSET);
ACSI_ASSERT_ALIGNED_2(ACSIEMUL_PUN_INFO_P_COOKPTR_OFFSET);
ACSI_ASSERT_ALIGNED_2(ACSIEMUL_PUN_INFO_P_VERSION_OFFSET);
ACSI_ASSERT_ALIGNED_2(ACSIEMUL_PUN_INFO_P_MAX_SECTOR_OFFSET);
ACSI_ASSERT_ALIGNED_2(ACSIEMUL_PUN_INFO_RESERVED_OFFSET);
_Static_assert(ACSIEMUL_PUN_INFO_RESERVED_OFFSET + ACSI_PUN_INFO_MAXUNITS * 4u <=
                   ACSIEMUL_PUN_INFO_OFFSET + ACSI_PUN_INFO_SIZE,
               "pun_info must fit its slot");
...
#define ACSIEMUL_REBIND_SKIP_NO_MAGIC 7u
