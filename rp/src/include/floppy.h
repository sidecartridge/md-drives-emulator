...
_Static_assert(FLOPPYEMUL_IMAGE < ROM_SIZE_BYTES,
               "FLOPPYEMUL_IMAGE must stay within the emulated ROM buffer");

#define FLOPPY_ASSERT_ALIGNED_2(offset) \
  _Static_assert(((offset) & 0x1u) == 0u, #offset " must stay 2-byte aligned")
#define FLOPPY_ASSERT_ALIGNED_4(offset) \
  _Static_assert(((offset) & 0x3u) == 0u, #offset " must stay 4-byte aligned")

// Shared-memory layout contract for FLOPPYEMUL.
FLOPPY_ASSERT_ALIGNED_4(FLOPPYEMUL_OLD_XBIOS_TRAP);
FLOPPY_ASSERT_ALIGNED_2(FLOPPYEMUL_BPB_DATA_A);
FLOPPY_ASSERT_ALIGNED_2(FLOPPYEMUL_BPB_TRACKCNT_A);
FLOPPY_ASSERT_ALIGNED_2(FLOPPYEMUL_BPB_SIDECNT_A);
FLOPPY_ASSERT_ALIGNED_2(FLOPPYEMUL_SECPCYL_A);
FLOPPY_ASSERT_ALIGNED_2(FLOPPYEMUL_SECPTRACK_A);
FLOPPY_ASSERT_ALIGNED_2(FLOPPYEMUL_DISK_NUMBER_A);
FLOPPY_ASSERT_ALIGNED_2(FLOPPYEMUL_BPB_DATA_B);
FLOPPY_ASSERT_ALIGNED_2(FLOPPYEMUL_BPB_TRACKCNT_B);
FLOPPY_ASSERT_ALIGNED_2(FLOPPYEMUL_BPB_SIDECNT_B);
