...
#define TERM_KEYBOARD_SCAN_CODE_1 2
#define TERM_KEYBOARD_SCAN_CODE_2 3
#define TERM_KEYBOARD_SCAN_CODE_3 4
#define TERM_KEYBOARD_SCAN_CODE_4 5
#define TERM_KEYBOARD_SCAN_CODE_5 6
#define TERM_KEYBOARD_SCAN_CODE_6 7
#define TERM_KEYBOARD_SCAN_CODE_7 8
#define TERM_KEYBOARD_SCAN_CODE_8 9
#define TERM_KEYBOARD_SCAN_CODE_9 10
#define TERM_KEYBOARD_SCAN_CODE_0 11
