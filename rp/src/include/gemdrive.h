...
#define GEMDRIVE_ASSERT_ALIGNED_4(offset) \
  _Static_assert(((offset) & 0x3u) == 0u, #offset " must stay 4-byte aligned")

// Shared-memory layout contract for GEMDRIVE.
GEMDRIVE_ASSERT_ALIGNED_4(GEMDRIVE_REENTRY_TRAP);
GEMDRIVE_ASSERT_ALIGNED_2(GEMDRIVE_DTA_F_FOUND);
GEMDRIVE_ASSERT_ALIGNED_4(GEMDRIVE_DTA_TRANSFER);
GEMDRIVE_ASSERT_ALIGNED_2(GEMDRIVE_DTA_TRANSFER + 22);
GEMDRIVE_ASSERT_ALIGNED_2(GEMDRIVE_DTA_TRANSFER + 24);
GEMDRIVE_ASSERT_ALIGNED_2(GEMDRIVE_DTA_TRANSFER + 26);
GEMDRIVE_ASSERT_ALIGNED_2(GEMDRIVE_DTA_TRANSFER + 28);
GEMDRIVE_ASSERT_ALIGNED_4(GEMDRIVE_DTA_EXIST);
GEMDRIVE_ASSERT_ALIGNED_4(GEMDRIVE_DTA_RELEASE);
GEMDRIVE_ASSERT_ALIGNED_4(GEMDRIVE_SET_DPATH_STATUS);
GEMDRIVE_ASSERT_ALIGNED_4(GEMDRIVE_FOPEN_HANDLE);
GEMDRIVE_ASSERT_ALIGNED_4(GEMDRIVE_READ_BYTES);
GEMDRIVE_ASSERT_ALIGNED_4(GEMDRIVE_READ_BUFF);
GEMDRIVE_ASSERT_ALIGNED_4(GEMDRIVE_WRITE_BYTES);
GEMDRIVE_ASSERT_ALIGNED_4(GEMDRIVE_WRITE_CHK);
GEMDRIVE_ASSERT_ALIGNED_4(GEMDRIVE_WRITE_CONFIRM_STATUS);
GEMDRIVE_ASSERT_ALIGNED_4(GEMDRIVE_FCLOSE_STATUS);
GEMDRIVE_ASSERT_ALIGNED_4(GEMDRIVE_DCREATE_STATUS);
GEMDRIVE_ASSERT_ALIGNED_4(GEMDRIVE_DDELETE_STATUS);
GEMDRIVE_ASSERT_ALIGNED_4(GEMDRIVE_EXEC_HEADER);
GEMDRIVE_ASSERT_ALIGNED_4(GEMDRIVE_FCREATE_HANDLE);
GEMDRIVE_ASSERT_ALIGNED_4(GEMDRIVE_FDELETE_STATUS);
GEMDRIVE_ASSERT_ALIGNED_4(GEMDRIVE_FSEEK_STATUS);
GEMDRIVE_ASSERT_ALIGNED_4(GEMDRIVE_FATTRIB_STATUS);
GEMDRIVE_ASSERT_ALIGNED_4(GEMDRIVE_FRENAME_STATUS);
GEMDRIVE_ASSERT_ALIGNED_4(GEMDRIVE_FDATETIME_DATE);
GEMDRIVE_ASSERT_ALIGNED_4(GEMDRIVE_FDATETIME_TIME);
GEMDRIVE_ASSERT_ALIGNED_4(GEMDRIVE_FDATETIME_STATUS);
GEMDRIVE_ASSERT_ALIGNED_4(GEMDRIVE_DFREE_STATUS);
GEMDRIVE_ASSERT_ALIGNED_4(GEMDRIVE_DFREE_STRUCT);
GEMDRIVE_ASSERT_ALIGNED_4(GEMDRIVE_PEXEC_MODE);
GEMDRIVE_ASSERT_ALIGNED_4(GEMDRIVE_PEXEC_STACK_ADDR);
